...
// UpdateMinedFishcakePower is a paid mutator transaction binding the contract method 0xa59d02cd.
//
// Solidity: function updateMinedFishcakePower(address _miner, uint256 _power) returns()
func (_FishcakeEventManager *FishcakeEventManagerTransactor) UpdateMinedFishcakePower(opts *bind.TransactOpts, _miner common.Address, _power *big.Int) (*types.Transaction, error) {
	return _FishcakeEventManager.contract.Transact(opts, "updateMinedFishcakePower", _miner, _power)
}

// UpdateMinedFishcakePower is a paid mutator transaction binding the contract method 0xa59d02cd.
//
// Solidity: function updateMinedFishcakePower(address _miner, uint256 _power) returns()
func (_FishcakeEventManager *FishcakeEventManagerSession) UpdateMinedFishcakePower(_miner common.Address, _power *big.Int) (*types.Transaction, error) {
	return _FishcakeEventManager.Contract.UpdateMinedFishcakePower(&_FishcakeEventManager.TransactOpts, _miner, _power)
}

// UpdateMinedFishcakePower is a paid mutator transaction binding the contract method 0xa59d02cd.
//
// Solidity: function updateMinedFishcakePower(address _miner, uint256 _power) returns()
func (_FishcakeEventManager *FishcakeEventManagerTransactorSession) UpdateMinedFishcakePower(_miner common.Address, _power *big.Int) (*types.Transaction, error) {
	return _FishcakeEventManager.Contract.UpdateMinedFishcakePower(&_FishcakeEventManager.TransactOpts, _miner, _power)
}
