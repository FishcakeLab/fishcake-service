...
// FilterActivityAdd is a free log retrieval operation binding the contract event 0x3506de3288d7be2fbbbc5cccb79a0195aed1511c93003f8e135856a9e0210644.
//
// Solidity: event ActivityAdd(address indexed who, uint256 _activityId, uint256 _totalDropAmts)
func (_MerchantManger *MerchantMangerFilterer) FilterActivityAdd(opts *bind.FilterOpts, who []common.Address) (*MerchantMangerActivityAddIterator, error) {
	...
	logs, sub, err := _MerchantManger.contract.FilterLogs(opts, "ActivityAdd", whoRule)
	if err != nil {
		return nil, err
	}
...
// WatchActivityAdd is a free log subscription operation binding the contract event 0x3506de3288d7be2fbbbc5cccb79a0195aed1511c93003f8e135856a9e0210644.
//
// Solidity: event ActivityAdd(address indexed who, uint256 _activityId, uint256 _totalDropAmts)
func (_MerchantManger *MerchantMangerFilterer) WatchActivityAdd(opts *bind.WatchOpts, sink chan<- *MerchantMangerActivityAdd, who []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _MerchantManger.contract.WatchLogs(opts, "ActivityAdd", whoRule)
	if err != nil {
		return nil, err
	}
...
// ParseActivityAdd is a log parse operation binding the contract event 0x3506de3288d7be2fbbbc5cccb79a0195aed1511c93003f8e135856a9e0210644.
//
// Solidity: event ActivityAdd(address indexed who, uint256 _activityId, uint256 _totalDropAmts)
