...
// DepositIntoStaking is a paid mutator transaction binding the contract method 0x7970e73f.
//
// Solidity: function depositIntoStaking(uint256 amount, uint8 stakingType, bool isAutoRenew) returns()
func (_StakingManager *StakingManagerTransactor) DepositIntoStaking(opts *bind.TransactOpts, amount *big.Int, stakingType uint8, isAutoRenew bool) (*types.Transaction, error) {
	return _StakingManager.contract.Transact(opts, "depositIntoStaking", amount, stakingType, isAutoRenew)
}

// DepositIntoStaking is a paid mutator transaction binding the contract method 0x7970e73f.
//
// Solidity: function depositIntoStaking(uint256 amount, uint8 stakingType, bool isAutoRenew) returns()
func (_StakingManager *StakingManagerSession) DepositIntoStaking(amount *big.Int, stakingType uint8, isAutoRenew bool) (*types.Transaction, error) {
	return _StakingManager.Contract.DepositIntoStaking(&_StakingManager.TransactOpts, amount, stakingType, isAutoRenew)
}

// DepositIntoStaking is a paid mutator transaction binding the contract method 0x7970e73f.
//
// Solidity: function depositIntoStaking(uint256 amount, uint8 stakingType, bool isAutoRenew) returns()
func (_StakingManager *StakingManagerTransactorSession) DepositIntoStaking(amount *big.Int, stakingType uint8, isAutoRenew bool) (*types.Transaction, error) {
	return _StakingManager.Contract.DepositIntoStaking(&_StakingManager.TransactOpts, amount, stakingType, isAutoRenew)
}
